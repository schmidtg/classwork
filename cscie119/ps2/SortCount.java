...
public class SortCount {
   ...
   /**
     ...
     * swapSort
     *
     * Sorts an array by comparing the first element to each element
     * in the array and swaps those elements that are out of order
     * until all elements have been put in place
     * */
    ...
    public static void main(String args[]) {
        ...
        /*
         * Test Code - swapSort
         * Programming Question 3b.
         *
         * Continuously create the arrays based on number of tests we want to perform.
         */
        System.out.println("swapSort Test Code\t\t");
        System.out.println("n\ttype\t\trun\t\tcomps\t\tmoves");
